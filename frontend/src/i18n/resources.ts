...
export const EN_TRANSLATIONS = {
  ...
  keyboardShortcutsHelp: {
    ...
    titles: {
      ...
      markdownEditor: "Markdown editor shortcuts",
      textViewer: "Text viewer shortcuts",
      textEditor: "Text editor shortcuts",
    },
  },
  app: {
    loading: "Loading...",
  ...
  fileBrowser: {
    ...
    row: {
      ...
      unsavedLocalDraft: "Unsaved local draft available",
      unsavedLocalDraftSuffix: ": unsaved local draft available",
    ...
    shortcuts: {
      ...
      extractArchive: "Extract ZIP archive",
      fileSearch: "Search recent and current-directory files",
    ...
    createItem: {
      ...
      inputLabel: "Name",
      descriptionFile: "Create the new file in the destination directory.",
      descriptionDirectory: "Create the new directory in the destination directory.",
      buttonCreating: "Creating…",
    },
    archive: {
      createTitle: "Create ZIP Archive",
      nameLabel: "Archive name",
      createDescription_one: "Create a ZIP archive from 1 selected item in the destination directory.",
      createDescription_other: "Create a ZIP archive from {{count}} selected items in the destination directory.",
      progressCreating: "Creating archive...",
      progressPreparing: "Preparing archive...",
      progressProcessedMembers: "Processed {{processed}} archive items...",
      ...
      createPartialOutputError: "Archive creation failed. The new ZIP file may be incomplete.",
      createCancelled: "Archive creation was cancelled.",
      buttonCancelCreation: "Cancel archive creation",
      progressSourceArchive: "Source archive",
      progressMembers: "{{completed}} of {{total}} members",
      progressBytes: "{{processed}} of {{total}} bytes",
      interruptedAfterReload: "Archive work was interrupted. Check its destination before retrying.",
      ...
      previewError: "Archive member preview could not be loaded.",
      previewTooLarge: "This archive member is too large to preview. Download it to view the file.",
      previewUnavailable: "This file type cannot be previewed here. Download it to open it with another application.",
      closeBrowser: "Close archive browser",
      root: "Archive root",
      breadcrumbs: "Archive path",
      historyBack: "Back",
      historyForward: "Forward",
      up: "Up",
      more: "Load more",
      entryUnavailable: "Unavailable",
      extractTitle: "Extract from ZIP Archive",
      extractDescriptionArchive: "Extract the archive to the destination directory.",
      extractDescriptionMember: "Extract the selected item to the destination directory.",
      extractDescriptionMembers_one: "Extract 1 selected item to the destination directory.",
      extractDescriptionMembers_other: "Extract {{count}} selected items to the destination directory.",
      memberErrorTitle: "Resolve extraction issue",
      memberErrorPrompt: "An archive member could not be extracted.",
      ...
      buttonCancelExtraction: "Cancel extraction",
      buttonOpenDestination: "Open destination",
      buttonRetryMemberError: "Retry member",
      buttonIgnoreMemberError: "Skip member",
      validationDestinationEmpty: "Enter a destination directory.",
      validationDestinationUnsafe: "Use a relative directory path without empty, '.' or '..' segments.",
      validationDestinationExists: "Choose a new destination directory. Archive extraction does not overwrite existing directories.",
      extractError: "Archive extraction failed.",
      extractPartialOutputError: "Archive extraction failed. The destination directory may contain incomplete files.",
      extractSuccess: "Archive extraction completed.",
      summaryFilesExtracted: "Files extracted",
      summaryDirectoriesCreated: "Directories created",
      summaryBytesWritten: "Bytes written",
      summaryFilesSkipped: "Files skipped",
      summaryFilesReplaced: "Files replaced",
      summaryPartialMembers: "Partial members",
      extractPartialSuccess_one: "Archive extraction completed with 1 unavailable member skipped.",
      extractPartialSuccess_other: "Archive extraction completed with {{count}} unavailable members skipped.",
      extractCancelled: "Archive extraction was cancelled.",
      extractInterrupted: "Archive extraction was interrupted. The destination may contain partial output.",
      extractConflictPending: "Archive extraction is waiting for a collision decision.",
      collisionTitle: "Files Already Exist",
      collisionPrompt: "Choose how to handle these existing destination files.",
      collisionListLabel: "Conflicting archive members",
      collisionMore: "{{count}} more conflicting files.",
      collisionArchiveMemberLabel: "Archive member",
      collisionDestinationPathLabel: "Target path",
      collisionArchiveColumn: "Archive",
      collisionDestinationColumn: "Existing",
      collisionSizeLabel: "Size",
      collisionModifiedLabel: "Modified",
      collisionByteCount: "{{count}} bytes",
      collisionResolutionLabel: "Choose a resolution",
      collisionChoiceSkip: "Skip this file",
      collisionChoiceReplace: "Replace this file",
      collisionChoiceReplaceOlder: "Replace all files only when the archive file is newer",
      collisionChoiceRename: "Rename extracted file",
      collisionApplyRemaining: "Apply this choice to remaining conflicts",
      collisionContinue: "Continue",
      memberErrorTargetLabel: "Target path",
      memberErrorPartialOutputNote: "A partial target file was created. Retrying starts this member again.",
      ...
      buttonRename: "Rename",
      renameTargetLabel: "New destination path",
    },
    nameDialog: {
    ...
    copyMove: {
      descriptionCopySingle: "Copy this item to the destination directory.",
      descriptionCopyMultiple_one: "Copy this item to the destination directory.",
      descriptionCopyMultiple_other: "Copy {{count}} selected items to the destination directory.",
      descriptionMoveSingle: "Move this item to the destination directory.",
      descriptionMoveMultiple_one: "Move this item to the destination directory.",
      descriptionMoveMultiple_other: "Move {{count}} selected items to the destination directory.",
    ...
    overwriteConflict: {
      ...
      metadataLabel: "Target details",
      resolutionLabel: "Choose a resolution",
      resolutionSkip: "Skip",
      resolutionOverwrite: "Overwrite",
      resolutionOverwriteOnlyOlder: "Overwrite only older",
      resolutionRename: "Rename",
      applyToAll: "Apply this choice to remaining conflicts in this operation",
      targetNameUnchanged: "Choose a different target name.",
      noResolutionAvailable: "No resolution is available for this target. Cancel the operation and try again.",
  ...
  viewer: {
    ...
    edit: {
      ...
      recovery: {
        ...
        newerDescription: "An unsaved local draft is available and was updated after the saved file.",
      ...
      caseSensitiveShortcut: "Match case (Alt+C)",
      find: "Find",
      findReplace: "Find and replace",
      findWithHistory: "Search (⇅ for history)",
      invalidRegularExpression: "Invalid regular expression",
      matchOptions: "Match options",
      nextMatch: "Next match",
      previousMatch: "Previous match",
      regularExpression: "Use regular expression",
      regularExpressionShortcut: "Use regular expression (Alt+R)",
      replaceAll: "Replace all",
      replaceCurrent: "Replace current match",
      wholeWord: "Match whole word",
      wholeWordShortcut: "Match whole word (Alt+W)",
      bold: "Bold",
      removeBold: "Remove bold",
      italic: "Italic",
      replace: "Replace",
      replaceWithHistory: "Replace (⇅ for history)",
